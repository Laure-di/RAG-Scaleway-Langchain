...
import time
import warnings
from multiprocessing.util import DEBUG_FLAG
...
from scaleway.inference.v1beta1.types import EndpointSpec, EndpointSpecPublic, Deployment
...
def chat(new_message: str, deployment: Deployment, vector_store: PGVector, llm: ChatOpenAI):
...
def main():
    ...
    while question != 'quit':
        ...
        if question != 'quit':
            chat(question, deployment, vector_store, llm)
